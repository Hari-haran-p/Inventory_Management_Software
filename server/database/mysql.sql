...
--
-- Temporary table structure for view `admin_stock_view`
--
...
--
-- Temporary table structure for view `categories_view`
--
...
CREATE TABLE `department` (
  ...
  `incharge_faculty_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `faculty` VALUES ('AT01235','NATARAJ N','PROFESSOR -2','nataraj@bitsathy.ac.in','9715884848','SLB008','slbincharge'),('STU008','Hariharan P','STUDENT-3','hariharanp.cs21@bitsathy.ac.in','1234645433','SLB009','slbincharge'),('STU009','Sai Prashanth K','STUDENT-3','saiprashanth.cs21@bitsathy.ac.in','1234567890','SLB008','slbincharge'),('STU010','Kavinraj k','STUDENT-3','kavinraj.cs21@bitsathy.ac.in','1213321231','SLB007','slsincharge');
...
CREATE TABLE `itemtable` (
  ...
  `cost_per_item` int(255) NOT NULL,
...
INSERT INTO `itemtable` VALUES ('SLBS000072','Plumping - Hardware','clear varnish','varnish','Wooden varnish',90,'Per ltr','SLSM0000000015','SLSS0000000010'),('SLBS000073','Electronics','LED DISPLAY POWER SUPPLY','light','5V 300W',1199,'Per item','SLSM0000000045','SLSS0000000010'),('SLBS000074','Electronics','LED LOGO POWER SUPPLY','Power Supply','AC DC',570,'Per item','SLSM0000000017','SLSS0000000025'),('SLBS000075','Electronics','HDMI - VGA CONVERTER','Power Supply','AC DC',699,'Per item','SLSM0000000021','SLSS0000000022'),('SLBS000076','Electronics','SINGLE PHASE ELECTRONIC WATT-HOUR METER','Power Supply','AC DC',499,'Per item','SLSM0000000038','SLSS0000000016'),('SLBS000077','Electricals - Hardware','ULTASONIC TRASNMITTER AND RECIEVER','GL-40-2R','Utrasonic sensor',155,'Per item','SLSM0000000019','SLSS0000000016'),('SLBS000078','Electricals - Batteries','DC TO DC BUCK CONVERTER','LM2596 ','Converter',186,'Per item','SLSM0000000028','SLSS0000000021'),('SLBS000079','Electricals - Batteries','DC TO DC BUCK CONVERTER','LM2596 ','Converter',186,'Per item','SLSM0000000028','SLSS0000000021'),('SLBS000080','Electricals - Batteries','GPS RECIEVER','RS232 ','used for Gps project ',255,'Per item','SLSM0000000019','SLSS0000000010'),('SLBS000097','MS/AL Pipes & sheets - Hardware','sample1','sample1','sample1',21,'Per m','SLSM0000000015','SLSS0000000012'),('SLBS000098','Plumping-Hardware','sample2','sample2','sample2',32131,'Per dozen','SLSM0000000015','SLSS0000000009'),('SLBS000099','MS/AL Pipes & sheets - Hardware','MOBILEPHONE','varnish','cell phone',3000,'Per item','SLSM0000000015','SLSS0000000010'),('SLBS000100','Electronics','LAPTOP','light','gaming lap',20000,'Per item','SLSM0000000045','SLSS0000000010'),('SLBS000101','Electronics','RASPBERRY PI','Power Supply','electronic compoent',7000,'Per item','SLSM0000000017','SLSS0000000025');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `itemtable_insert` BEFORE INSERT ON `itemtable` FOR EACH ROW 
BEGIN
...
INSERT INTO `itemtable_seq` VALUES (72),(73),(74),(75),(76),(77),(78),(79),(80),(81),(82),(83),(84),(85),(86),(87),(88),(89),(90),(91),(92),(94),(95),(96),(97),(98),(99),(100),(101);
/*!40000 ALTER TABLE `itemtable_seq` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary table structure for view `lab_inventory_view`
--
...
--
-- Temporary table structure for view `lab_item_view`
--
...
--
-- Temporary table structure for view `labs_stock_view`
--
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `manufacturer_table_insert` BEFORE INSERT ON `manufacturer` FOR EACH ROW 
BEGIN
...
--
-- Temporary table structure for view `overall_scrap_value`
--
...
--
-- Temporary table structure for view `overall_stock_view`
--
...
--
-- Temporary table structure for view `scrap_table_view`
--
...
INSERT INTO `scraptable` VALUES (17,'SLBS000072','SLSM0000000015','SLSS0000000010',1,'STU010','2023-09-21 10:11:20',90,'SLB007','REJECTED','Rejected because of new item','STU010'),(20,'SLBS000076','SLSM0000000038','SLSS0000000016',1,'STU009','2023-09-16 21:52:03',499,'SLB008','APPROVED',NULL,'STU010'),(27,'SLBS000076','SLSM0000000038','SLSS0000000016',1,'STU009','2023-09-21 10:11:36',499,'SLB008','REJECTED','rejected','STU010'),(28,'SLBS000075','SLSM0000000021','SLSS0000000022',1,'STU008','2023-09-21 12:46:14',699,'SLB009','APPROVED',NULL,'STU010');
...
INSERT INTO `supplier` VALUES ('SLSS0000000009','ST ENTERPRISES`','ERODE','9384984600','2023-08-11 10:38:18'),('SLSS0000000010','SURYA AGENCIES','GOBICHETTIPALAYAM','9843327636','2023-08-11 10:39:03'),('SLSS0000000011','ORIENT HARDWARE & TOOLS CORPORATION','COIMBATORE','4224072222','2023-08-11 10:39:32'),('SLSS0000000012','SRI GOLDEN REFRIGERATION','SANGANUR MAIN ROAD, COIMBATORE','9364473175','2023-08-11 10:39:48'),('SLSS0000000016','AAMBIENT AC','GANAPATHY, COIMBATORE','7558020929','2023-08-11 10:40:09'),('SLSS0000000017','STAR METAL ENGINEERING CORPORATION','KATTOR, COIMBATORE','9789721317','2023-08-11 10:40:28'),('SLSS0000000018','CHENNIMALAI ANDAVAR TEXTILES','ERODE','9842952095','2023-08-11 10:40:43'),('SLSS0000000019','GURUS STORES','SATHYAMANGALAM','9994161169','2023-08-11 10:40:59'),('SLSS0000000020','SARAVANA SILKS','SATHYAMANGALAM','9994236815','2023-08-11 10:41:11'),('SLSS0000000021','INNOVATE ENGINERING PRODUCTS','HOSUR','9047866448','2023-08-11 10:41:49'),('SLSS0000000022','CHENNIMALAI ANDAVAR TEXTILES','ERODE','9842952095','2023-08-11 19:39:02'),('SLSS0000000023','GURUS STORES','SATHYAMANGALAM','9994161169','2023-08-11 19:39:14'),('SLSS0000000024','INNOVATE ENGINERING PRODUCTS','HOSUR','9047866448','2023-08-11 19:39:26'),('SLSS0000000025','SRI BALAJI SCIENTIFIC INSTRUMETS','96/2, CHURCH STREET, COIMBATORE','9994850948','2023-08-11 19:39:41'),('SLSS0000000026','MAGIZH SUPER STORE','SATHY','9486668910','2023-08-11 19:39:53'),('SLSS0000000027','SRI PONNACHIAMMAN STORES','SATHY','4295299464','2023-08-11 19:40:05');
...
--
-- Temporary table structure for view `transfer_request_merged_view`
--
...
--
-- Temporary table structure for view `transfer_request_view`
--
...
INSERT INTO `transfertable` VALUES (28,'SLBS000075','SLSM0000000021','SLSS0000000022',5,'SLB008','slb009','STU009','2023-09-06 20:47:24','APPROVED',NULL),(31,'SLBS000073','SLSM0000000045','SLSS0000000010',2,'SLB009','slb008','STU008','2023-09-14 10:37:52','REJECTED','Rejectted'),(32,'SLBS000073','SLSM0000000045','SLSS0000000010',2,'SLB009','slb008','STU008','2023-09-09 21:02:09','REJECTED','Not available'),(38,'SLBS000072','SLSM0000000015','SLSS0000000010',10,'SLB008','slb009','STU009','2023-09-06 21:39:01','APPROVED',NULL),(39,'SLBS000072','SLSM0000000015','SLSS0000000010',2,'SLB008','slb009','STU009','2023-09-06 21:43:53','APPROVED',NULL),(42,'SLBS000072','SLSM0000000015','SLSS0000000010',4,'SLB008','slb009','STU009','2023-09-09 21:02:09','REJECTED','item required foe us'),(45,'SLBS000072','SLSM0000000015','SLSS0000000010',1,'SLB008','slb009','STU009','2023-09-09 21:02:09','REJECTED','item scraped'),(46,'SLBS000072','SLSM0000000015','SLSS0000000010',6,'SLB009','slb008','STU008','2023-09-07 22:39:47','APPROVED',NULL),(48,'SLBS000072','SLSM0000000015','SLSS0000000010',2,'SLB009','slb008','STU008','2023-09-08 21:25:14','APPROVED',NULL),(51,'SLBS000072','SLSM0000000015','SLSS0000000010',2,'SLB009','SLB008','STU008','2023-09-10 11:12:34','REJECTED','data rejected sample'),(52,'SLBS000072','SLSM0000000015','SLSS0000000010',3,'SLB007','slb009','STU010','2023-09-14 11:23:37','APPROVED','sadasdad adfaqw'),(53,'SLBS000072','SLSM0000000015','SLSS0000000010',1,'SLB007','slbs','STU010','2023-11-21 09:26:12','CANCELED',NULL),(54,'SLBS000072','SLSM0000000015','SLSS0000000010',1,'SLB007','slb007','STU010','2023-09-14 11:44:51','PENDING',NULL),(55,'SLBS000072','SLSM0000000015','SLSS0000000010',1,'SLB009','slb007','STU008','2023-09-14 12:16:39','PENDING',NULL),(56,'SLBS000072','SLSM0000000015','SLSS0000000010',1,'SLB008','slb008','STU009','2023-09-14 16:22:06','REJECTED','simply ill reject'),(57,'SLBS000072','SLSM0000000015','SLSS0000000010',1,'SLB008','slb008','STU009','2023-09-14 16:19:33','REJECTED','No reason simply rejecting meet me'),(62,'SLBS000072','SLSM0000000015','SLSS0000000010',9,'SLB008','slb009','STU009','2023-09-20 10:05:23','REJECTED','rejected'),(63,'SLBS000072','SLSM0000000015','SLSS0000000010',1,'SLB008','slb009','STU009','2023-09-20 10:10:38','APPROVED',NULL),(64,'SLBS000072','SLSM0000000015','SLSS0000000010',1,'SLB009','slb008','STU008','2023-09-20 10:13:03','APPROVED',NULL),(65,'SLBS000072','SLSM0000000015','SLSS0000000010',6,'SLB008','slb009','STU009','2023-09-20 10:16:13','APPROVED',NULL),(66,'SLBS000072','SLSM0000000015','SLSS0000000010',1,'SLB009','slb008','STU008','2023-09-20 11:45:31','APPROVED',NULL),(67,'SLBS000074','SLSM0000000017','SLSS0000000025',2,'SLB008','slb009','STU009','2023-09-20 12:02:29','APPROVED',NULL),(68,'SLBS000075','SLSM0000000021','SLSS0000000022',1,'SLB008','slb009','STU009','2023-09-21 10:34:00','LABAPPROVED',NULL),(69,'SLBS000075','SLSM0000000021','SLSS0000000022',1,'SLB008','slb007','STU009','2023-09-22 05:10:07','PENDING',NULL),(70,'SLBS000075','SLSM0000000021','SLSS0000000022',1,'SLB008','slb009','AT01235','2023-11-03 04:55:37','PENDING',NULL);
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `categories_view` AS select `stocktable`.`stock_qty` AS `Stock`,`itemtable`.`item_type` AS `name` from (`stocktable` join `itemtable` on((`stocktable`.`item_code` = `itemtable`.`item_code`))) group by `itemtable`.`item_type`,`stocktable`.`stock_qty` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `transfer_request_merged_view` AS (select `transfer_request_view`.`id` AS `id`,`transfer_request_view`.`item_code` AS `item_code`,`transfer_request_view`.`item_name` AS `item_name`,`transfer_request_view`.`item_subname` AS `item_subname`,`transfer_request_view`.`item_description` AS `item_description`,`transfer_request_view`.`cost_per_item` AS `cost_per_item`,`transfer_request_view`.`item_type` AS `item_type`,`transfer_request_view`.`quantity_units` AS `quantity_units`,`transfer_request_view`.`transfer_to` AS `transfer_to`,`transfer_request_view`.`transfer_qty` AS `transfer_qty`,`transfer_request_view`.`transfered_from` AS `transfered_from`,`transfer_request_view`.`user_id` AS `user_id`,`transfer_request_view`.`manufacturer_id` AS `manufacturer_id`,`transfer_request_view`.`supplier_id` AS `supplier_id`,`transfer_request_view`.`status` AS `status`,`transfer_request_view`.`username` AS `username`,`transfer_request_view`.`request_labname` AS `request_labname`,`transfer_request_view`.`reject_description` AS `reject_description`,`transfer_request_view`.`date` AS `date`,`labdetails`.`labname` AS `from_labname` from (`transfer_request_view` left join `labdetails` on((convert(`transfer_request_view`.`transfered_from` using utf8) = `labdetails`.`labcode`)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2023-12-09 12:07:23

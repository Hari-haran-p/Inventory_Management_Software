...
function ScrapRequestTable({ isVisible, user, setMessage, setError, isLoading, setIsLoading, getStock, fetchGetStock, fetchTableData, fetchPendingData, noRequestData }) {
            ...
            >
              <table class="min-w-full text-sm">
                ...
                <tbody style={{ backgroundColor: "white", fontWeight: "bold", color: "black" }}>
                  {filteredData && filteredData.slice(startIndex, endIndex).map((data, index) => {
                    return (
                      <tr
                        key={data.id}

...
import { IoMailOutline } from "react-icons/io5"; // Import email icon
...
function Vendors({ open }) {
    ...
    async function fetchSupplier() {
        const response = await getRequest(`${BackendUrl}/api/getSupplier`).catch(
    ...
    useEffect(() => {
        setSupplierTotalPages(
            Math.ceil(supplierFilteredData.length / rowSizeSupplier)
        );
    ...
    const supplierEndIndex = Math.min(
        supplierStartIndex + rowSizeSupplier,
        supplierFilteredData.length
    );
                ...
                <div className="overflow-x-hidden h-auto w-auto flex flex-col items-center justify-center">
                    ...
                    >
                        <div className="border-2 duration-500 rounded-lg  lg:w-5/12 w-full">
                            ...
                            <div
                                className=" overflow-y-auto rounded-2xl overflow-x-auto border-gray-700 duration-500"
                        ...
                        <div className="border-2  rounded-md duration-500 lg:w-7/12 w-full">
                            ...
                            <div
                                className=" overflow-hidden overflow-y-auto overflow-x-auto border-gray-700 rounded-2xl duration-500"
                                style={{ minHeight: "40vh", maxWidth: "100%" }}
                            >
                                <div class=" align-middle inline-block min-w-full ">
                                    <div class="shadow overflow-hidden sm:rounded-lg">
                                        <table class="min-w-full text-sm ">
                                            <thead class="text-md uppercase border-b-2 font-medium">
                                                <tr>
                                                    ...
                                                    >
                                                        <div className="flex">
                                                            <div>Email</div>
                                                            {supplierSortedColumn === "email" && (
                                                                <i
                                                                    className={`bi bi-arrow-${
                                                                        supplierSortOrder.email === "asc"
                                                                            ? "up"
                                                                            : "down"
                                                                    } ml-2`}
                                                                ></i>
                                            ...
                                            <tbody
                                                style={{ backgroundColor: "white", fontWeight: "bold" }}
                                            >
                                                {supplierFilteredData
                                                    .slice(supplierStartIndex, supplierEndIndex)
                                                    .map((data, index) => {
                                                        return (
                                                            <tr class="bg-white" key={data.id}>
                                                                <td class="px-6 py-4 border-b-2">
                                                                    {supplierStartIndex + index + 1}
                                                                </td>
                            ...
                            <div className="w-full h-16 flex justify-between border-t-2 items-center rounded-b-3xl">
                                ...
                                >
                                    ...
                                    <option value={supplier.length < 50 ? supplier.length : 50}>
                                        50
                                    </option>

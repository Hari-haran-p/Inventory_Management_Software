  ...
  return (
    <>
      <div className="h-full w-full flex  bg-gray-100 flex-col">
        <h1 style={{ fontWeight: "bolder", fontSize: "30px", paddingLeft: "7%" }} class={`text-start pt-4`}>Manufacturer Entry </h1>
        {message ? (
          <div
        ...
        <div className="bg-gray-100 h-full w-full  px-14 animate1 py-5 flex flex-row-reverse  items-center justify-center rounded-lg">
            ...
            <div className="bg-white w-full md:w-10/12 shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]  rounded-2xl ">
              ...
              {/* <div className="   rounded-lg"> */}
                <div className="rounded-lg p-5 flex  flex-wrap flex-col justify-center items-start">
                  <div class="py-1 flex  pb-8 w-full">
                  ...
                  <form className="w-full">
                    <div class=" flex flex-wrap w-full pb-5">
                      ...
                      <input
                        ...
                        className="text-md block px-3 py-2 rounded-lg w-full border-2 border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none"
                      />
                    </div>
              ...
              <div className="py-1  flex pb-2 rounded-lg p-5">
          ...
          <div className=" h-full w-1/2 items-center hidden md:flex">
            <div className=" flex flex-col text-2xl font-medium gap-10">
              <span>M</span>
              <span>A</span>
              <span>N</span>
              <span>U</span>
